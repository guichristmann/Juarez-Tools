...
Head::Head()
{
	...
	m_LeftLimit = 120;
	m_RightLimit = -120;
	m_TopLimit = 145; //Kinematics::EYE_TILT_OFFSET_ANGLE;
	m_BottomLimit = 30; //Kinematics::EYE_TILT_OFFSET_ANGLE - 65;

	m_Pan_Home = 0.0;
	m_Tilt_Home = 90; //Kinematics::EYE_TILT_OFFSET_ANGLE - 30.0;
